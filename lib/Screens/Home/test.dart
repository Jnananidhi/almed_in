...
class ProductScreenFromSearch extends StatefulWidget {
  ...
  const ProductScreenFromSearch({super.key,this.selectedProductName});

  @override
  State<ProductScreenFromSearch> createState() => _ProductScreenState();
}
class _ProductScreenState extends State<ProductScreenFromSearch> {
