...
class ProductScreenTest2 extends StatefulWidget {
  const ProductScreenTest2({super.key});

  @override
  State<ProductScreenTest2> createState() => _ProductScreenTest2State();
}
class _ProductScreenTest2State extends State<ProductScreenTest2> {
  int currentPage = 0;
  int itemsPerPage = 10;
  ...
  Future<void> fetchAllProducts() async {
    ...
    if (response.statusCode == 200) {
      ...
      List<Productt> productsData =
      jsonData.map((item) => Productt.fromJson(item)).toList();
